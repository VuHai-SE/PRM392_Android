...
public class FootballLegendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_football_legends);
            ...
            public void onClick(View v) {
                ...
                if (!name.isEmpty() && !details.isEmpty()) {
                    if (!isDuplicate(name)) {
                        ...
                        Toast.makeText(FootballLegendsActivity.this, "Tên cầu thủ đã tồn tại", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(FootballLegendsActivity.this, "Vui lòng nhập tên và chi tiết", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedIndex != -1 && !name.isEmpty() && !details.isEmpty()) {
                    ...
                    Toast.makeText(FootballLegendsActivity.this, "Vui lòng chọn cầu thủ để cập nhật", Toast.LENGTH_SHORT).show();
                }
            }
        });
