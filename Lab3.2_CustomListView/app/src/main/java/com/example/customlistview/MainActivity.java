        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!ten.isEmpty() && !moTa.isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "Vui lòng nhập tên và mô tả", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedIndex != -1 && !ten.isEmpty() && !moTa.isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "Vui lòng chọn trái cây để cập nhật", Toast.LENGTH_SHORT).show();
                }
            }
        });
