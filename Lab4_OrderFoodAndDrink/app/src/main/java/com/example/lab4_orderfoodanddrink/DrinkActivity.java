...
public class DrinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drinkList.add(new Drink("Coffee", "Đồ uống phổ biến", R.drawable.coffee));
        drinkList.add(new Drink("Trà sữa", "Đồ uống yêu thích của giới trẻ", R.drawable.milk_tea));
        drinkList.add(new Drink("Pepsi", "Nước ngọt có gas", R.drawable.pepsi));
        drinkList.add(new Drink("Schweppes", "Nước uống có gas", R.drawable.schweppes));
        drinkList.add(new Drink("Soda", "Nước ngọt có gas", R.drawable.soda));
        ...
        btnDatMon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedDrinkIndex != -1) {
                    ...
                    resultIntent.putExtra("selectedDrink", drinkList.get(selectedDrinkIndex).getName());
